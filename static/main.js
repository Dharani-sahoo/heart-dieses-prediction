function validation() {
    ...
    if (f2 == "") {
        ...
        document.getElementById("sex").innerHTML = "sex can't be less than -1.60!";
        return false;
    }
    else if (f2 > 1.0) {
        document.getElementById("sex").innerHTML = "sex can't greater than 35.60!";
        return false;
    }
    else {
    ...
    if (f5 == "") {
        ...
        document.getElementById("chol").innerHTML = "chol can't be less than 0.40!";
        return false;
    }
    else if (f5 > 564.0) {
        document.getElementById("chol").innerHTML = "chol can't greater than 9.50!";
        return false;
    }
    else fbs
    ...
    if (f6 == "") {
        ...
        document.getElementById("fbs").innerHTML = "fbs can't be less than 0.40!";
        return false;
    }
    else if (f6 > 1.0) {
        document.getElementById("fbs").innerHTML = "fbs can't greater than 9.50!";
        return false;
    }
    else {
    ...
    if (f7 == "") {
        ...
        document.getElementById("restecg").innerHTML = "restecg can't be less than 0.40!";
        return false;
    }
    else if (f7 >2.0) {
        document.getElementById("restecg").innerHTML = "restecg can't greater than 9.50!";
        return false;
    }
    else {
    ...
    if (f8 == "") {
        ...
        document.getElementById("thalach").innerHTML = "thalachcan't be less than 0.40!";
        return false;
    }
    else if (f8 > 202.0) {
        document.getElementById("thalach").innerHTML = "thalach can't greater than 9.50!";
        return false;
    }
    else {
    ...
    if (f9 == "") {
        ...
        document.getElementById("exang").innerHTML = "exang can't be less than 0.40!";
        return false;
    }
    else if (f9 > 1.0) {
        document.getElementById("exang").innerHTML = "exang can't greater than 9.50!";
        return false;
    }
    else {
    ...
    if (f10 == "") {
        ...
        document.getElementById("oldpeak").innerHTML = "oldpeak can't be less than 0.40!";
        return false;
    }
    else if (f10 > 6.20) {
        document.getElementById("oldpeak").innerHTML = "oldpeak can't greater than 9.50!";
        return false;
    }
    else {
    ...
    if (f11 == "") {
        ...
        document.getElementById("slope").innerHTML = "slope can't be less than 0.40!";
        return false;
    }
    else if (f11 > 2.0) {
        document.getElementById("slope").innerHTML = "slope can't greater than 9.50!";
        return false;
    }
    else {
    ...
    if (f12 == "") {
        ...
        document.getElementById("ca").innerHTML = "ca can't be less than 0.40!";
        return false;
    }
    else if (f12 > 4.0) {
        document.getElementById("ca").innerHTML = "ca can't greater than 9.50!";
        return false;
    }
    else {
    ...
    if (f13 == "") {
        ...
        document.getElementById("thal").innerHTML = "thal can't be less than 0.40!";
        return false;
    }
    else if (f13 > 3.0) {
        document.getElementById("thal").innerHTML = "thal can't greater than 9.50!";
        return false;
    }
    else {
